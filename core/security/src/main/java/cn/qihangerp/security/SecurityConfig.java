...
//                .logout().disable()
                ...
                .authorizeHttpRequests(authorizeHttpRequests -> authorizeHttpRequests
                        ...
                        .requestMatchers(HttpMethod.GET, "/code_callback").permitAll()
...
//                        .requestMatchers(HttpMethod.GET, "/*/ship/order_ship").permitAll()
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/erp-api/supplier/login").permitAll()
