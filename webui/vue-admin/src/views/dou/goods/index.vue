...
<!--      <el-table-column label="ID" align="center" prop="id" />-->
      <el-table-column label="电商平台SKUID" align="left" prop="specId"  width="180px">
...
<!--      <el-table-column label="平台SKU ID" align="center" prop="id" />-->
      ...
      <el-table-column label="商品标题" align="left" prop="name" />
...
<!--      </el-table-column>-->
      <el-table-column label="规格" align="center" prop="specDetailName1" >
        <template slot-scope="scope">
          {{scope.row.specDetailName1}} {{scope.row.specDetailName2}} {{scope.row.specDetailName3}}
        </template>
      </el-table-column>
      <el-table-column label="销售价" align="center" prop="price" :formatter="amountFormatter">
        <template slot-scope="scope">{{amountFormatter(null,null,scope.row.price / 100)}}</template>
      </el-table-column>
  ...
  methods: {
    ...
    handleLink(row) {
      ...
      getGoodsSku(id).then(response => {
        ...
        this.form.skuCode = response.data.code
        this.open = true;
      });
    },
    /** 提交按钮 */
