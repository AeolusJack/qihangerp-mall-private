...
<!--          >快递公司库</el-button>-->
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="100px">
        ...
        <el-form-item label="appSercet" prop="appSercet" v-if="form.type===500">
    ...
    <el-dialog :title="title" :visible.sync="authOpen" width="500px" append-to-body>
      <el-form ref="tokenForm" :model="tokenForm"  :rules="rules" label-width="80px">
        ...
        <el-descriptions v-if="tokenForm.shopType === 100">
          <el-descriptions-item label="请设置淘宝开放平台回调URL"> http://ip:8088/api/open-api/tao/code_callback</el-descriptions-item>
        </el-descriptions>
...
<script>
import {listShopPage, listShop,listPlatform, getShop, delShop, addShop, updateShop ,getShopPullTime,saveShopPullTime,updateShopManage} from "@/api/shop/shop";
