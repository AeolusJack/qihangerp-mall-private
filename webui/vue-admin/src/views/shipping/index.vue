  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="100px">
      ...
      <el-form-item label="供应商" prop="supplierId">
        <el-select v-model="queryParams.supplierId" placeholder="请选择供应商" clearable @change="handleQuery">
          <el-option
...
<!--                <el-image  style="width: 40px; height: 40px;" :src="scope.row.goodsImg" :preview-src-list="[scope.row.goodsImg]"></el-image>-->
      ...
      <el-table-column label="供应商" prop="receiverName" width="200px">
        <template slot-scope="scope">
...
<script>
import {listOrder, getOrder } from "@/api/order/ship_order";
import { listShop } from "@/api/shop/shop";
import {listSupplier} from "@/api/goods/supplier";
// import {logisticsUpdate} from "@/api/shipping/ship";
