...
import waybillAccountDou from "@/views/shipping/ewaybillAccount/dou.vue";
import printJd from "@/views/shipping/ewaybillPrint/jd/index.vue";
import waybillAccountWei from "@/views/shipping/ewaybillAccount/wei.vue";
...
export default {
  ...
  components:{
    waybillAccountDou,
    printTao,printPdd,printJd,waybillAccountWei,printOffline},
  data() {
    return {
      activeName: '',
      typeList: [],
