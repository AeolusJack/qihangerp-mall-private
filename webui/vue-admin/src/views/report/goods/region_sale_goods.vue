...
<!--      <el-table-column label="ID" align="center" prop="id" />-->
      ...
      <el-table-column label="订单数" align="center" prop="orderTotal" />

      <el-table-column label="刷单数" align="center" prop="falseOrderTotal" />
      <el-table-column label="刷单金额" align="center" prop="falseOrderAmount" :formatter="amountFormatter" width="200px">

      </el-table-column>
      <el-table-column label="广告费" align="center" prop="adFee" >
        <template slot-scope="scope">
      ...
      <el-table-column label="ROI" align="center"  >
        <template slot-scope="scope">
          {{(scope.row.adFee/ scope.row.orderAmount *100).toFixed(2) }}
        </template>
      </el-table-column>
      <el-table-column label="平均客单价" align="center"  >
        <template slot-scope="scope">
      ...
      <el-table-column label="广告占比" align="center" >
        <template slot-scope="scope">
          {{(scope.row.adFee/ allAdFee *100).toFixed(2) }}%
        </template>
      </el-table-column>
      <el-table-column label="销售占比" align="center" >
        <template slot-scope="scope">
