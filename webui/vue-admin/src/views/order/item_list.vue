...
<!--      </el-form-item>-->
      ...
      <el-form-item label="供应商" prop="shipSupplier">
        <el-select v-model="queryParams.shipSupplier" placeholder="请选择发货供应商" clearable @change="handleQuery">
          <el-option
...
export default {
  ...
  created() {
     listShop({}).then(response => {
       ...
       listSupplier({}).then(response => {
         ...
         this.supplierList.push({id:0,name:'无供应商'})
         this.getList();
       });
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('/api/oms-api/order/item/export', {
        ...this.queryParams
