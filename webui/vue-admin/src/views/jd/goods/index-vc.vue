...
<!--      </el-form-item>-->
      ...
      <el-form-item label="状态" prop="saleState">
        <el-select v-model="queryParams.saleState" placeholder="全部" clearable @change="handleQuery">
          <el-option label="下柜" value="0"></el-option>
          <el-option label="上柜" value="1"></el-option>
          <el-option label="可上柜" value="2"></el-option>
        </el-select>
      </el-form-item>
...
<!--      <el-table-column label="商家编码" align="center" prop="outerId" />-->
      <el-table-column label="商品标题" align="left" prop="wareName" />
      <el-table-column label="商品库SKU ID" align="center" prop="ogoodsSkuId" />
      <el-table-column label="状态" align="center" prop="saleState" >
        <template slot-scope="scope">
          <el-tag size="small" v-if="scope.row.saleState === 0">下柜</el-tag>
          <el-tag size="small" v-if="scope.row.saleState === 1">上柜</el-tag>
          <el-tag size="small" v-if="scope.row.saleState === 2">可上柜</el-tag>
        </template>
      </el-table-column>
...
import {listGoodsSku,getGoodsSku,linkErpGoodsSkuId,pullGoodsList} from "@/api/jdvc/goods";
